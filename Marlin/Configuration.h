...
#define STRING_CONFIG_H_AUTHOR "Greg" // Who made the changes.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no
// quotes)
...
#define SERIAL_PORT -1
 ...
 /**
  * Select a secondary serial port on the board to use for communication with the
  * host. Currently Ethernet (-2) is only supported on Teensy 4.1 boards.
  * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
  */
 ...
 * EXTRUDERS = 5) SMUFF_EMU_MMU2  : Technik Gegg SMuFF (Průša MMU2 emulation
 * mode) SMUFF_EMU_MMU2S : Technik Gegg SMuFF (Průša MMU2S emulation mode)
 *
...
// A dual-nozzle that uses a servomotor to raise/lower one (or both) of the
// nozzles
//#define SWITCHING_NOZZLE
#if ENABLED(SWITCHING_NOZZLE)
#define SWITCHING_NOZZLE_SERVO_NR 0
//#define SWITCHING_NOZZLE_E1_SERVO_NR 1          // If two servos are used, the
// index of the second
...
//#define PRIME_BEFORE_REMOVE                       // Prime the nozzle before
// release from the dock
 ...
 *   - Extends the stepping routines to move multiple steppers in proportion to
 * the mix.
 *   - Optional support for Repetier Firmware's 'M164 S<index>' supporting
 * virtual tools.
 *   - This implementation supports up to two mixing extruders.
 *   - Enable DIRECT_MIXING_IN_G1 for M165 and mixing in G1 (from Pia Taubert's
...
// commands #define GRADIENT_MIX           // Support for gradient mixing with
// M166 and LCD
#if ENABLED(GRADIENT_MIX)
//#define GRADIENT_VTOOL       // Add M166 T to use a V-tool index as a Gradient
// alias
#endif
#endif

// Offset of the extruders (uncomment if using more than one and relying on
// firmware to position when changing). The offset has to be X=0, Y=0 for the
// extruder 0 hotend (default extruder). For the other hotends it is their
// distance from the extruder 0 hotend.
//#define HOTEND_OFFSET_X { 0.0, 20.00 } // (mm) relative X-offset for each
// nozzle #define HOTEND_OFFSET_Y { 0.0, 5.00 }  // (mm) relative Y-offset for
// each nozzle #define HOTEND_OFFSET_Z { 0.0, 0.00 }  // (mm) relative Z-offset
// for each nozzle
...
//#define PSU_DEFAULT_OFF         // Keep power off until enabled directly with
// M80 #define PSU_POWERUP_DELAY 250   // (ms) Delay for the PSU to warm up to
// full power

//#define PSU_POWERUP_GCODE  "M355 S1"  // G-code to run after power-on (e.g.,
// case light on) #define PSU_POWEROFF_GCODE "M355 S0"  // G-code to run before
// power-off (e.g., case light off)
...
//#define AUTO_POWER_E_TEMP        50 // (°C) Turn on PSU if any extruder is
// over this temperature #define AUTO_POWER_CHAMBER_TEMP  30 // (°C) Turn on PSU
// if the chamber is over this temperature #define AUTO_POWER_COOLER_TEMP   26
// // (°C) Turn on PSU if the cooler is over this temperature
 ...
 * at high temp. !! 5 : 100K thermistor - ATC Semitec 104GT-2/104NT-4-R025H42G
 * (Used in ParCan, J-Head, and E3D) (4.7k pullup) 501 : 100K Zonestar (Tronxy
 * X3A) Thermistor 502 : 100K Zonestar Thermistor used by hot bed in Zonestar
 * Průša P802M 512 : 100k RPW-Ultra hotend thermistor (4.7k pullup) 6 : 100k
 * EPCOS - Not as accurate as table 1 (created using a fluke thermocouple) (4.7k
 * pullup) 7 : 100k Honeywell thermistor 135-104LAG-J01 (4.7k pullup) 71 : 100k
 * Honeywell thermistor 135-104LAF-J01 (4.7k pullup) 8 : 100k 0603 SMD Vishay
 * NTCS0603E3104FXT (4.7k pullup) 9 : 100k GE Sensing AL03006-58.2K-97-G1 (4.7k
 * pullup) 10 : 100k RS thermistor 198-961 (4.7k pullup) 11 : 100k beta 3950 1%
 * thermistor (Used in Keenovo AC silicone mats and most Wanhao i3 machines)
 * (4.7k pullup) 12 : 100k 0603 SMD Vishay NTCS0603E3104FXT (4.7k pullup)
 * (calibrated for Makibox hot bed) 13 : 100k Hisens 3950  1% up to 300°C for
 * hotend "Simple ONE " & "Hotend "All In ONE" 15 : 100k thermistor calibration
 * for JGAurora A5 hotend 18 : ATC Semitec 204GT-2 (4.7k pullup) Dagoma.Fr -
 * MKS_Base_DKU001327 20 : Pt100 with circuit in the Ultimainboard V2.x with
 * mainboard ADC reference voltage = INA826 amplifier-board supply voltage.
 *         NOTES: (1) Must use an ADC input with no pullup. (2) Some INA826
 * amplifiers are unreliable at 3.3V so consider using sensor 147, 110, or 21.
 *    21 : Pt100 with circuit in the Ultimainboard V2.x with 3.3v ADC reference
 * voltage (STM32, LPC176x....) and 5V INA826 amplifier board supply. NOTE: ADC
 * pins are not 5V tolerant. Not recommended because it's possible to damage the
 * CPU by going over 500°C. 22 : 100k (hotend) with 4.7k pullup to 3.3V and 220R
 * to analog input (as in GTM32 Pro vB) 23 : 100k (bed) with 4.7k pullup to 3.3v
 * and 220R to analog input (as in GTM32 Pro vB) 30 : Kis3d Silicone heating mat
 * 200W/300W with 6mm precision cast plate (EN AW 5083) NTC100K / B3950 (4.7k
 * pullup) 201 : Pt100 with circuit in Overlord, similar to Ultimainboard V2.x
 *    60 : 100k Maker's Tool Works Kapton Bed Thermistor beta=3950
 *    61 : 100k Formbot / Vivedino 3950 350C thermistor 4.7k pullup
 *    66 : 4.7M High Temperature thermistor from Dyze Design
 *    67 : 450C thermistor from SliceEngineering
 *    70 : the 100K thermistor found in the bq Hephestos 2
 *    75 : 100k Generic Silicon Heat Pad with NTC 100K MGB18-104F39050L32
 * thermistor 99 : 100k thermistor with a 10K pull-up resistor (found on some
 * Wanhao i3 machines)
 *
 *       1k ohm pullup tables - This is atypical, and requires changing out
 * the 4.7k pullup for 1k. (but gives greater accuracy and more stable PID) 51 :
 * 100k thermistor - EPCOS (1k pullup) 52 : 200k thermistor - ATC Semitec
 * 204GT-2 (1k pullup) 55 : 100k thermistor - ATC Semitec 104GT-2 (Used in
 * ParCan & J-Head) (1k pullup)
 *
 ...
 * machine. 998 : Dummy Table that ALWAYS reads 25°C or the temperature defined
 * below. 999 : Dummy Table that ALWAYS reads 100°C or the temperature defined
 * below.
 */
...
//#define MAX31865_SENSOR_OHMS_0      100   // (Ω) Typically 100 or 1000 (PT100
// or PT1000) #define MAX31865_CALIBRATION_OHMS_0 430   // (Ω) Typically 430 for
// AdaFruit PT100; 4300 for AdaFruit PT1000 #define MAX31865_SENSOR_OHMS_1 100
...
// failures. (Use MINTEMP for thermistor short/failure protection.)
...
#if ENABLED(PIDTEMP)
//#define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings"
// menu. (~700 bytes of PROGMEM) #define PID_AUTOTUNE_MENU     // Add PID
// auto-tuning to the "Advanced Settings" menu. (~250 bytes of PROGMEM) #define
// PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder
//(useful for mismatched extruders)
// Set/get with gcode: M301 E[extruder number, 0-2]

#if ENABLED(PID_PARAMS_PER_HOTEND)
// Specify between 1 and HOTENDS values per array.
// If fewer than EXTRUDER values are provided, the last element will be
// repeated.
 ...
 * If this option is disabled, bang-bang will be used and BED_LIMIT_SWITCHING
 * will enable hysteresis.
 *
 * The PID frequency will be the same as the extruder PWM.
 * If PID_dT is the default, and correct for the hardware/configuration, that
 * means 7.689Hz, which is fine for driving a square wave into a resistive load
 * and does not significantly impact FET heating. This also works fine on a
 * Fotek SSR-10DA Solid State Relay into a 250W heater. If your configuration is
 * significantly different than this and you don't understand the issues
 * involved, don't use bed PID until someone else verifies that your hardware
 * works.
 */
 //#define PIDTEMPBED
 ...
 * CHAMBER_LIMIT_SWITCHING will enable hysteresis.
 *
 * The PID frequency will be the same as the extruder PWM.
 * If PID_dT is the default, and correct for the hardware/configuration, that
 * means 7.689Hz, which is fine for driving a square wave into a resistive load
 * and does not significantly impact FET heating. This also works fine on a
 * Fotek SSR-10DA Solid State Relay into a 200W heater. If your configuration is
 * significantly different than this and you don't understand the issues
 * involved, don't use chamber PID until someone else verifies that your
 * hardware works.
 */
...
#define MIN_CHAMBER_POWER 0
  ...
  // Lasko "MyHeat Personal Heater" (200w) modified with a Fotek SSR-10DA to
  // control only the heating element and placed inside the small Creality printer
  // enclosure tent.
  //
...
// FIND YOUR OWN: "M303 E-2 C8 S50" to run autotune on the chamber at 50
// degreesC for 8 cycles.
#endif // PIDTEMPCHAMBER

#if ANY(PIDTEMP, PIDTEMPBED, PIDTEMPCHAMBER)
//#define PID_DEBUG             // Sends debug data to the serial port. Use
//'M303 D' to toggle activation. #define PID_OPENLOOP          // Puts PID in
// open loop. M104/M140 sets the output power from 0 to PID_MAX #define
// SLOW_PWM_HEATERS      // PWM with very low frequency (roughly 0.125Hz=8s) and
...
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN
    ...
    */
     ...
     */
     ...
     /**
      * The "Manual Probe" provides a means to do "Auto" Bed Leveling without a
      * probe. Use G29 repeatedly, adjusting the Z height at each point with movement
      * commands or (with LCD_BED_LEVELING) the LCD controller.
      */
        ...
        */
         ...
         */
          ...
          */
           ...
           *
           * This probe is deployed and activated by moving the X-axis to a magnet at the
           * edge of the bed. By default, the magnet is assumed to be on the left and
           * activated by a home. If the magnet is on the right, enable and set
           * TOUCH_MI_DEPLOY_XPOS to the deploy position.
           *
...
// side of the bed #define TOUCH_MI_MANUAL_DEPLOY                // For manual
// deploy (LCD menu)
#endif
...
// A probe deployed by moving the x-axis, such as the Wilson II's
// rack-and-pinion probe designed by Marty Rice.
 ...
 */
  ...
  *     O-- FRONT --+
  */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -14.25 }
...
//#define Z_AFTER_PROBING           18 // Z position after probing is done
...
//#define WAIT_FOR_BED_HEATER     // Wait for bed to heat back up between probes
//(to improve accuracy) #define WAIT_FOR_HOTEND         // Wait for hotend to
// heat back up between probes (to improve accuracy & prevent cold extrude)
#endif
//#define PROBING_FANS_OFF          // Turn fans off when probing
//#define PROBING_STEPPERS_OFF      // Turn steppers off (unless needed to hold
// position) when probing #define DELAY_BEFORE_PROBING 200  // (ms) To prevent
 ...
 *  - Use a large value (i.e., Z_MAX_POS) if the bed falls down, away from the
 * nozzle.
 */
 //#define Z_IDLE_HEIGHT Z_HOME_POS

 #define Z_HOMING_HEIGHT  0      // (mm) Minimal Z height before homing (G28)
 // for Z clearance above the bed, clamps, ...
 // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

 #define Z_AFTER_HOMING  18      // (mm) Height to move to after homing Z
 ...
 *
 * IMPORTANT: Runout will only trigger if Marlin is aware that a print job is
 * running. Marlin knows a print job is running when:
...
// runout pins. #define WATCH_ALL_RUNOUT_SENSORS      // Execute runout script
// on any triggering sensor, not only for the active extruder.
...
// With multiple runout sensors use the %c placeholder for the current tool in
// commands (e.g., "M600 T%c") NOTE: After 'M412 H1' the host handles filament
// runout and this script does not apply.
 ...
 * perform leveling in steps so you can manually adjust the Z height at each
 * grid-point. With an LCD controller the process is guided step-by-step.
 */
...
//#define UBL_HILBERT_CURVE       // Use Hilbert distribution for less travel
// when probing multiple points
...
#define GRID_MAX_POINTS_X \
    3 // Don't use more than 7 points per axis, implementation limited.
#define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define LEVEL_CORNERS_Z_HOP \
    4.0 // (mm) Z height of nozzle between leveling points
//#define LEVEL_CENTER_TOO              // Move to the center after the last
// corner #define LEVEL_CORNERS_USE_PROBE
#if ENABLED(LEVEL_CORNERS_USE_PROBE)
#define LEVEL_CORNERS_PROBE_TOLERANCE 0.1
#define LEVEL_CORNERS_VERIFY_RAISED // After adjustment triggers the probe, \
    // re-probe to verify
...
#define LEVEL_CORNERS_LEVELING_ORDER \
  ...
  */
  ...
  // - If stepper drivers time out, it will need X and Y homing again before Z
  // homing.
 ...
 *       at a fixed bed location. "S" specifies strokes (i.e. back-forth
 * motions) between the start / end points.
 *
...
// Dual hotend system may use { {  -20, (Y_BED_SIZE / 2), (Z_MIN_POS + 1) },  {
// 420, (Y_BED_SIZE / 2), (Z_MIN_POS + 1) }}
...
//#define NOZZLE_CLEAN_HEATUP       // Heat up the nozzle instead of skipping
// wipe
...
#define PRINTCOUNTER_SAVE_INTERVAL \
    60 // (minutes) EEPROM save interval during print
#endif
...
#define PASSWORD_UNLOCK_GCODE // Unlock with the M511 P<password> command. \
    // Disable to prevent brute-force attack.
#define PASSWORD_CHANGE_GCODE // Change the password with M512 P<old> S<new>.
//#define PASSWORD_ON_SD_PRINT_MENU       // This does not prevent gcodes from
// running #define PASSWORD_AFTER_SD_PRINT_END #define
// PASSWORD_AFTER_SD_PRINT_ABORT #include "Configuration_Secure.h"       //
// External file with PASSWORD_DEFAULT_VALUE
#endif
 ...
 * 'cz':'Czech', 'da':'Danish', 'de':'German', 'el':'Greek', 'el_gr':'Greek
 * (Greece)', 'es':'Spanish', 'eu':'Basque-Euskera', 'fi':'Finnish',
 * 'fr':'French', 'gl':'Galician', 'hr':'Croatian', 'hu':'Hungarian',
 * 'it':'Italian', 'jp_kana':'Japanese', 'ko_KR':'Korean (South Korea)',
 * 'nl':'Dutch', 'pl':'Polish', 'pt':'Portuguese', 'pt_br':'Portuguese
 * (Brazilian)', 'ro':'Romanian', 'ru':'Russian', 'sk':'Slovak', 'sv':'Swedish',
 * 'tr':'Turkish', 'uk':'Ukrainian', 'vi':'Vietnamese', 'zh_CN':'Chinese
 * (Simplified)', 'zh_TW':'Chinese (Traditional)' }
 */
     ...
     */
      ...
      */
       ...
       */
       ...
       //
       // Add individual axis homing items (Home X, Home Y, and Home Z) to the LCD
       // menu.
       //
...
//
//#define ZONESTAR_LCD            // Requires ADC_KEYPAD_PIN to be assigned to
// an analog pin.
...
// LiquidCrystal_I2C library. For more info:
...
//
// Original Ulticontroller from Ultimaker 2 printer with SSD1309 I2C display and
// encoder
...
// MKS_MINI_12864 pinout. https://www.aliexpress.com/item/33018110072.html
//
//#define MKS_LCD12864
...
//
//#define FYSETC_MINI_12864_X_X    // Type C/D/E/F. No tunable RGB Backlight by
// default #define FYSETC_MINI_12864_1_2    // Type C/D/E/F. Simple RGB
// Backlight (always on) #define FYSETC_MINI_12864_2_0    // Type A/B. Discreet
// RGB Backlight #define FYSETC_MINI_12864_2_1    // Type A/B. NeoPixel RGB
// Backlight #define FYSETC_GENERIC_12864_1_1 // Larger display with basic
// ON/OFF backlight.
...
// (For CR-10 owners who want to replace the Melzi Creality board but retain the
// display)
//
...
//(default) #define ZONESTAR_12864OLED_SSD1306  // 0.96" OLED with SSD1306
// controller
...
//#define EXTUI_LOCAL_BEEPER // Enables use of local Beeper pin with external
// display
#endif
...
// :[ 'AUTO', 'ST7735', 'ST7789', 'ST7796', 'R61505', 'ILI9328', 'ILI9341',
// 'ILI9488' ]
 ...
 *   TFT_COLOR_UI   - Marlin Default Menus, Touch Friendly, using full TFT
 * capabilities TFT_LVGL_UI    - A Modern UI using LVGL
 *
...
// Increase the FAN PWM frequency. Removes the PWM noise but increases heating
// in the FET/Arduino
//#define FAST_PWM_FAN

// Use software PWM to drive the fan, as for the heaters. This uses a very low
// frequency which is not as annoying as with the hardware PWM. On the other
// hand, if this frequency is too low, you should also increment SOFT_PWM_SCALE.
//#define FAN_SOFT_PWM
...
#define PRINTER_EVENT_LEDS
  ...
  */
  ...
  // its target angle. 300ms is a good value but you can try less delay. If the
  // servo can't reach the requested position, increase it.
#define SERVO_DELAY \
    {               \
        300         \
    }
